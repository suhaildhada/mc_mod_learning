...
import static com.suhail.learning.setup.Registers.ITEMS;
...
public class ArmorSetEntry {
    ...
    public static ArmorSetEntry build(String name, Holder<ArmorMaterial> material, int durabilityMultiplier,
        ...
        e.helmet = ITEMS.register(name + "_helmet", () -> hf.apply(material, ArmorItem.Type.HELMET, props(ArmorItem.Type.HELMET, durabilityMultiplier)));
        e.chestplate = ITEMS.register(name + "_chestplate", () -> cf.apply(material, ArmorItem.Type.CHESTPLATE, props(ArmorItem.Type.CHESTPLATE, durabilityMultiplier)));
        e.leggings = ITEMS.register(name + "_leggings", () -> lf.apply(material, ArmorItem.Type.LEGGINGS, props(ArmorItem.Type.LEGGINGS, durabilityMultiplier)));
        e.boots = ITEMS.register(name + "_boots", () -> bf.apply(material, ArmorItem.Type.BOOTS, props(ArmorItem.Type.BOOTS, durabilityMultiplier)));
        return e;
    }
